            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Lista de tipo de consumo</h1>
                        <div class="card mb-2">
                            <div class="card-body">
                                ...
                                <table  class="table table-striped">
                                    <thead>
                                    <tr>
										<th scope="col">Nombre de consumo</th>
										<th scope="col" colspan="2">Operaciones</th>
									</tr>
                                    </thead>
									<tbody>
										<?php foreach($data["Detalles"] as $tipoComida):?>
										<tr>
											<td><?= $tipoComida["tico_nombre"] ?></td>

											<td><a href="tipo_comida_editar_html.php?tico_id=<?= $tipoComida['tico_id'] ?>" class="btn "><i class="fa-solid fa-pen-to-square"></i></a></td>
											<td><a href="tipo_comida_eliminar_html.php?tico_id=<?= $tipoComida['tico_id'] ?>" class="btn"><i class="fas fa-trash" color="#FF0000" ></i></i></td>
										</tr>
										<?php endforeach ?>
									</tbody>
                                </table>
