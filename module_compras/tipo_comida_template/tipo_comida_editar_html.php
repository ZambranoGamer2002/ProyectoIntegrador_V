<?php 
	if($_SERVER["REQUEST_METHOD"]=="POST"){
        ...
        CURLOPT_URL => 'https://cevicherias.informaticapp.com/TipoComida/'.$_POST['tico_id'],
                        ...
                        <div class="card mb-4">
							...
							<form method="post">
								<div class="mb-3">
                                        ...
                                        <input type="text" name="tico_nombre" value="<?= $data["Detalles"]['tico_nombre'] ?>" class="form-control" aria-describedby="emailHelp">
                                </div>
