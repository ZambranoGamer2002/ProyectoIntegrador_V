                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <form method="post">
                                <input type="hidden" name="tipr_id" value="<?= $data["Detalles"]["0"]['tipr_id'] ?>">
                                <input type="hidden" name="sucu_id" value="<?= $valorGlobal["0"]["sucu_id"] ?>">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="tipr_descripcion" class="form-control" value="<?= $data["Detalles"]["0"]['tipr_descripcion'] ?>">                                   
                                    </div>
