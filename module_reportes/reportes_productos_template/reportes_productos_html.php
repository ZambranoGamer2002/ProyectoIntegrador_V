                        ...
                        <div class="card mb-2">
                            <div class="card-body">
                                ...
                                <table class="table">
                                  ...
                                  <tbody>
                                    <?php foreach($data["Detalles"] as $reporte_producto):?>
										<tr>
											<td><?= $reporte_producto["prod_nombre"] ?></td>
											<td><?= $reporte_producto["prod_precio"] ?></td>
											<td><?= $reporte_producto["prod_estado"] ?></td>
											<td><?= $reporte_producto["prod_unidad"] ?></td>
										</tr>
                                    <?php endforeach ?>
                                </tbody>
                              </table>
