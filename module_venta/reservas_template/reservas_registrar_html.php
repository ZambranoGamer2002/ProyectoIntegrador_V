                            ...
                            <div class="card-body">
                                ...
                                <form method="post">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="res_autor" class="form-control">
                                        <input type="hidden" name="sucu_id" value="<?= $valorGlobal["0"]["sucu_id"] ?>">
                                        <input type="hidden" name="res_fecha_pedido" id="res_fecha_pedido" value="<?= date('Y-m-d') ?>" required class="form-control" aria-describedby="emailHelp">
                                    </div>

                                    <div class="mb-3">
                                        <label for="exampleInputEmail1" class="form-label">Fecha para cuando reservas</label>
                                        <input type="date" name="res_fecha_reserva" class="form-control">
                                    </div>

                                    <div class="mb-3">
                                        <label for="exampleInputEmail1" class="form-label">Hora (formato en 24 horas)</label>
                                        <input type="time" name="res_hora" class="form-control">
                                    </div>
