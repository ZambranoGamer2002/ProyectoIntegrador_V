...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(40, 10, utf8_decode('Tipo de Reclamo'), 1, 0, 'C', 1);
      $this->Cell(150, 10, utf8_decode('Descripción'), 1, 1, 'C', 1);
...
foreach($data["Detalles"] as $reporte_reclamos):

$pdf->Cell(40, 10, $reporte_reclamos["recl_tipo_reclamo"], 1, 0, 'C', 0);
$pdf->Cell(150, 10, $reporte_reclamos["recl_descrip"], 1, 1, 'C', 0);

endforeach;

$pdf->Output('Reportes_Reclamos.pdf', 'I');//nombreDescarga, Visor(I->visualizar - D->descargar)