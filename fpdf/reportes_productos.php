...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(55  , 10, utf8_decode('Estado'), 1, 0, 'C', 1);
      $this->Cell(35, 10, utf8_decode('Unidad'), 1, 1, 'C', 1);
...
foreach($data["Detalles"] as $reporte_productos):

$pdf->Cell(50, 10, $reporte_productos["prod_nombre"], 1, 0, 'C', 0);
$pdf->Cell(50, 10, $reporte_productos["prod_precio"], 1, 0, 'C', 0);
$pdf->Cell(55, 10, $reporte_productos["prod_estado"], 1, 0, 'C', 0);
$pdf->Cell(35, 10, $reporte_productos["prod_unidad"], 1, 1, 'C', 0);
