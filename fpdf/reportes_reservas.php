...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(50, 10, utf8_decode('Nombres y Apellidos'), 1, 0, 'C', 1);
      $this->Cell(50, 10, utf8_decode('Fecha del pedido'), 1, 0, 'C', 1);
      $this->Cell(55  , 10, utf8_decode('Fecha de la reserva'), 1, 0, 'C', 1);
      $this->Cell(35, 10, utf8_decode('Hora'), 1, 1, 'C', 1);
...
foreach($data["Detalles"] as $reporte_reservas):

$pdf->Cell(50, 10, $reporte_reservas["per_nombres"], 1, 0, 'C', 0);
$pdf->Cell(50, 10, $reporte_reservas["res_fecha_pedido"], 1, 0, 'C', 0);
$pdf->Cell(55, 10, $reporte_reservas["res_fecha_reserva"], 1, 0, 'C', 0);
$pdf->Cell(35, 10, $reporte_reservas["res_hora"], 1, 1, 'C', 0);
// $pdf->Cell(50, 10, $reporte_clientes["pla_precio"], 1, 1, 'C', 0);
// $pdf->Cell(25, 10, utf8_decode("total"), 1, 1, 'C', 0);

endforeach;

$pdf->Output('Reportes_Productos.pdf', 'I');//nombreDescarga, Visor(I->visualizar - D->descargar)